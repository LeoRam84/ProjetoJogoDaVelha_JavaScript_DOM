...
function disableRegion(element) {
  element.classList.remove('cursor-pointer') // Se eu tivesse passado o cursor: pointer; no #gameBoard span (CSS) e não em uma classe específica chamada "".cursor-pointer" (CSS), para desabilitá-lo agora eu poderia usar: "element.style.cursor = 'default' "
...
function handleBoardClick(ev) {
  ...
  const region = span.dataset.region // Nº.Nº
  const rowColumnPair = region.split('.') // ["Nº", "Nº"]
